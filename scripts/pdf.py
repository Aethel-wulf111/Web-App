...
def generate_report(data,s,familly,filename):
    ...
    pdf_file.drawImage('malware_scores.png', 100, 320, 400, 250)
    ...
    #draw_graph("eae876886f19ba384f55778634a35a1d975414e83f22f6111e3e792f706301fe")
    img_reader = ImageReader(r"C:\Users\cherif\Documents\additionel\example_cropped.png")
    width, height = letter
